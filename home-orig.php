	...
	<div id="homepage">
		...
		<div id="homepageright">
			...
			<img src="<?php echo get_settings('home'); ?>/wp-content/themes/superchevy/images/upcomingevent.png"><br/>
				...
				<a href="<?php echo get_settings('home'); ?>/wp-content/themes/superchevy/images/lvms_superchevy.jpg" target="_blank"><img src="<?php echo get_settings('home'); ?>/wp-content/themes/superchevy/images/lvms_superchevy-sm.jpg"></a>
